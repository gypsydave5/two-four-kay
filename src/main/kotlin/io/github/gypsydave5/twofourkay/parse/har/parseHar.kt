...
fun Request.Companion.parseHar(harRequest: io.github.gypsydave5.twofourkay.parse.har.Request): Request = Request(
...
fun Response.Companion.parseHar(harResponse: io.github.gypsydave5.twofourkay.parse.har.Response): Response = Response(
